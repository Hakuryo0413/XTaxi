  ...
  return (
    <div className="flex flex-col items-center justify-center h-full bg-primary p-2 bg-[url('/src/image/cab-blue2.png')] p-2 hover:bg-[url('/src/image/cab-blue2.png')]">
      ...
      <div className="flex flex-col sm:flex-row sm:space-x-4 mb-2">
        <button className="bg-blue-500 text-white py-2 px-6 rounded-lg shadow-lg hover:bg-blue-600 mb-4 sm:mb-0 text-base sm:text-lg md:text-xl">
          BOOK TAXI
        </button>
        <button className="bg-blue-500 text-white py-2 px-6 rounded-lg shadow-lg hover:bg-gray-600 text-base sm:text-lg md:text-xl">
          GET ESTIMATE
        </button>
      </div>
